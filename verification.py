...
#  {name} автоматически заменяется на имя пользователя. Можешь менять текст.
# ============================================================================
WELCOME_TEXT = (
    "💫 <b>Привет, {name}!</b> 💫\n"
    "Ты попал в бота, где за друзей дают звёзды!\n"
    "Очень рад, что ты тут! ✨\n\n"
    "Совет: зови побольше друзей! 👥 💌\n\n"
    "С уважением, создатель. 💌\n\n"
    "📝 <b>ПРАВИЛА БОТА:</b>\n\n"
    "• Выплата — до 48 часов. ⏱️\n"
    "• Указывай юз (свой/друга).\n"
    "   Ошибся? Не выдам. ⛔\n"
    "• Накрутка твинками = бан. 🚫\n"
    "• Только русскоговорящие! 🇷🇺\n\n"
    "🤑 Выплаты: @dfdfffgfgdg\n"
    "💬 Вопросы: @JQwMiIIRQHHlii\n\n"
    "❗️ Не пиши ерунду — иначе бан!\n"
